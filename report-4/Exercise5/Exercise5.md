...
```
    ...
    <matplotlib.patches.FancyArrow at 0x221715fba10>
...
right_skew = ss.skew(data)
plt.hist(right_skew, alpha = .6)

mean = np.mean(right_skew)
median = np.median(right_skew)
print("mean:", mean, "median:", median)
```

    mean: 2.844810789136954 median: 2.844810789136954
...
```
    ...
    <matplotlib.lines.Line2D at 0x22171cfee90>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x22171f07b10>
