...
```python
sorted_by_red_cards = euro12.sort_values('Red Cards').Team
sorted_by_yellow_cards = euro12.sort_values('Yellow Cards').Team
```
...
```python
euro12.query('Team.str.startswith("G")', engine="python").Team
```
